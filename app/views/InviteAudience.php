    ...
    <form id="myForm" name="myForm" onsubmit=" method="POST" action="form_script.php" >
		...
		<div class="table-layout">
					...
					<?php 
                        ...
                        <div class='row-3'>
                            <label>Selected Audience:*</label><span id="errinf" class="err">Audience Emails required</span>
					...
					<option value="2">Attendance Confirmation</option>
                        ...
                        <div class="row-5">
                            <label>Sender's Email:*</label><span id="errsemail" class="err">Sender Email is required</span>
                    ...
                    <div class="right-col">
                        <div class='row-1'>
                            <label>Subject:*</label><span id="errsubject" class="err">Subject Title is required</span>
